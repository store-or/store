...
(function(a) {
                ...
                init: function(b) {
                    ...
                    if (f.next("div").hasClass(e)) h();
                        ...
                        c.find("." + e + "_footer") && c.find("." + e + "_content").css({
                            marginBottom: c.find("." + e + "_footer").outerHeight() + "px"
                        });
                        ...
                        n = !0; ("absolute" != f.parent().css("position") || "fixed" != f.parent().css("position")) && 270 > c.find("." + e + "_content").width() && 60 > c.find("." + e + "_content").height() && (n = !1);
                        g();
                        if (k.onDocumentClickClose) a("html").on("click." + e + "Event",
                            function(b) {
                        ...
                        c.find('[data-popModalBut="ok"]').bind("click",
                            function(c) {
                                var e;
                                k.onOkBut && a.isFunction(k.onOkBut) && (e = k.onOkBut(c)); ! 1 !== e && h()
                            });
                        c.find('[data-popModalBut="cancel"]').bind("click",
                            function() {
                                if (k.onCancelBut && a.isFunction(k.onCancelBut)) k.onCancelBut();
                                h()
                            });
                        a("html").on("keydown." + e + "Event",
                            function(a) {
                                27 == a.keyCode && h()
                            })
                    }
    ...
    a("* [data-popModalBind]").bind("click",
        function() {
    ...
    a("* [data-notifyModalBind]").bind("click",
        function() {
        ...
        var h = a(this),
            ...
            k = {
                init: function(b) {
                    ...
                    function v() {
                        d.find('[data-dialogModalBut="close"]').bind("click",
                            function() {
                                g()
                            });
                        d.find('[data-dialogModalBut="ok"]').bind("click",
                            function(c) {
                                var b;
                                l.onOkBut && a.isFunction(l.onOkBut) && (b = l.onOkBut(c)); ! 1 !== b && g()
                            });
                        d.find('[data-dialogModalBut="cancel"]').bind("click",
                            function() {
                    ...
                    0 < t && u.prepend(a('<div class="' + m + ' notactive"></div><div class="' + n + '"></div>'));
                    a("body").append(b);
                    d = a("." + c);
                    f = a("." + c + "_container");
                    ...
                    d.find(".close").bind("click",
                        function() {
                            g()
                        });
                    a("html").on("keydown." + c + "Event",
                        function(a) {
