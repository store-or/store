(function ($) {
    ...
    $.fn.pbTouchSlider = function (options) {
        ...
        pbSlider.slider_NavArrows = '<ul class="o-slider-arrows"><li class="o-slider-prev"><i class="fa fa-angle-left"></i></li><li class="o-slider-next"><i class="fa fa-angle-right"></i></li></ul>';
